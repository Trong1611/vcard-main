"""
Django settings for vcard_web project.
...
ALLOWED_HOSTS = ['*']
CSRF_TRUSTED_ORIGINS = ['http://qrconnecta.com', 'https://qrconnecta.com']
...
# Authentication
AUTHENTICATION_BACKENDS = ["vcard_web.backends.EmailBackend"]
